  ...
  Future<void> _handleLogin() async {
    ...
    try {
      ...
      if (mounted && userProvider.user != null) {
        ...
        // If user is still null after sign in, show error
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Login failed: Unable to load user data'),
      ...
      if (mounted) {
        ...
        if (errorMessage.contains('[') && errorMessage.contains(']')) {
          ...
          final end = errorMessage.indexOf(']');
          if (start != -1 && end != -1 && end > start) {
            errorMessage = errorMessage.substring(start + 1, end);
          }
        }
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
